...
class TalkdataForeignUserNewCommond extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'TalkdataForeignUserNewCommond {dayid?}';
...
//        $sql = "select * from plat_tj_code where plat_id='ptj02' and app_name = '铁头英雄' group by app_id,app_key,country_type"; // todo 测试
        ...
        foreach ($result as $key_num => $row){
            ...
            var_dump($gameinfo);
            TdDataNewFunction::foreignCreateData($row['app_key'],$gameinfo,$row['platform_id'],$day,$channel,$versions,$groupby);
