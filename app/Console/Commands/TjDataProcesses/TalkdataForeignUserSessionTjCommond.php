...
class TalkdataForeignUserSessionTjCommond extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'TalkdataForeignUserSessionTjCommond {dayid?}';
...
//            AND c_app_statistic_version.ad_status != 2";
        ...
        foreach ($result as $row){
            ...
            var_dump($gameinfo);
            TdDataFunction::foreignCountryCreateSessionData($row['app_key'],$gameinfo,$row['platform_id'],$day,$channel,$versions,$groupby);
        }
    }
