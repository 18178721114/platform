...
//                $url_applist = "https://platform.ironsrc.com/partners/publisher/mediation/applications/v4/stats?startDate={$dayid}&endDate={$dayid}&breakdowns=app,adSource,date,country";  //20170206更新接口地址
                $url_applist = "https://platform.ironsrc.com/partners/publisher/mediation/applications/v5/stats?startDate={$dayid}&endDate={$dayid}&breakdowns=app,adSource,date,country,instanceId&adSource=ironSource&metrics=revenue,impressions,clicks,adSourceResponses,adSourceResponses,adUnits";  //20200621更新接口地址
