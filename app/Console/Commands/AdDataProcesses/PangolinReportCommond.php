...
class PangolinReportCommond extends Command
{
    ...
    public function handle()
    {
        ...
        $sql = " select distinct platform_id,data_account as company_account,account_user_id as user_id,account_token as secret_key from c_platform_account_mapping where platform_id = 'pad272' and account_user_id <> '' and account_token <> '' ";
