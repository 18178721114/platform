...
class OppoHandworkTjHandleProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'OppoHandworkTjHandleProcesses {dayid?} ';
        ...
        try {
            ...
            foreach ($info as $k => $v) {
                ...
                if(($num)>0){
                    ...
                    $error_detail_arr[$k]['platform_id'] = 'ptj265';
                    $error_detail_arr[$k]['platform_name'] = 'OPPO统计数据';
                ...
                $array[$k]['account'] = 'zplay';
                $array[$k]['platform_id'] ='ptj265';
                ...
                $array[$k]['retn_new_seven'] = $json_info['7次日留存'];
                $array[$k]['retn_new_fourteen'] = $json_info['14次日留存'];
                $array[$k]['flow_type'] = 1;
            ...
            DB::commit();
            // 调用存储过程更新总表数据
//            DB::update("call tj_summary('ptj265')");
