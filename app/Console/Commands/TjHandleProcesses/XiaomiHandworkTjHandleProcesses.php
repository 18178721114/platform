...
class XiaomiHandworkTjHandleProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'XiaomiHandworkTjHandleProcesses {dayid?} ';
        ...
        try {
            ...
            foreach ($info as $k => $v) {
                ...
                if(($num)>0){
                    ...
                    $error_detail_arr[$k]['platform_id'] = 'ptj267';
                    $error_detail_arr[$k]['platform_name'] = '小米统计数据';
                    ...
                    $error_detail_arr[$k]['first_level_name'] = $json_info['应用ID'];
                ...
                $array[$k]['retn_new_one'] = $json_info['次日留存'];
                $array[$k]['retn_new_three'] = $json_info['三次日留存'];
                $array[$k]['retn_new_seven'] = $json_info['七次日留存'];
                $array[$k]['retn_new_thirty'] = $json_info['三十次日留存'];
                $array[$k]['flow_type'] = 1;
            ...
            // 调用存储过程更新总表数据
//            DB::update("call tj_summary('ptj267')");
