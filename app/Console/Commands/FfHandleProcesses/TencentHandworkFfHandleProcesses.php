...
class TencentHandworkFfHandleProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'TencentHandworkFfHandleProcesses {dayid?} ';
        ...
        try {
            foreach ($info as $k => $v) {
            	...
            	if(($num)>0){
                    ...
                    $error_detail_arr[$k]['money'] = $json_info['流水金额'];
                ...
                $array[$k]['pay_user'] = $json_info['流水玩家'];
                $array[$k]['pay_time'] = 0;
