...
class MeizuHandworkFfHandleProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'MeizuHandworkFfHandleProcesses {dayid?} ';
        ...
        try {
            foreach ($info as $k => $v) {
            	...
            	foreach ($app_list as $app_k => $app_v) {
                        if($json_info['APPID'] ==$app_v['billing_app_id']  ){
            	...
            	if(($num)>0){
                    ...
                    $error_detail_arr[$k]['money'] = $json_info['成功总金额']-$json_info['退款总金额'];
                ...
                $money = $json_info['成功总金额']-$json_info['退款总金额'];
