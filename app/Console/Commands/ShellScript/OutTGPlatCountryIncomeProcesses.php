...
class OutTGPlatCountryIncomeProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'OutTGPlatCountryIncomeProcesses {begin_date?} {end_date?}';
    ...
    public function handle()
    {
        ...
        zplay_basic_tg_plat_country_income
        WHERE
         date >= '$begin_date'  and   date <= '$end_date' ";
            ...
            $insert_sql = "
        INSERT INTO zplay_basic_tg_plat_country_income (
                date,
                app_id,
                country_id,
                income,
