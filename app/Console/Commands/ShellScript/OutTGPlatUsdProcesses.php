...
class OutTGPlatUsdProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'OutTGPlatUsdProcesses {begin_date?} {end_date?} ';
    ...
    public function handle()
    {
        ...
        zplay_basic_tg_plat_report_total_usd
        WHERE
        ...
        $insert_sql ="
        INSERT INTO zplay_basic_tg_plat_report_total_usd (
        date,
        app_id,
        os_id,
        country_id,
...
//        $update_sql= "UPDATE zplay_basic_tg_plat_report_total_usd usd,
//        c_currency_ex cur
//        SET usd.cost = usd.cost_cny / cur.currency_ex
//        WHERE
//        cur.`effective_time` = date_format( usd.date, '%Y%m' )
//        AND cur.`currency_id` = 60
//        AND usd.cost_cny = usd.cost
//        AND usd.date >= '$begin_date'
//        AND usd.date <= '$end_date'";
//        $update_sql_res = DB::update($update_sql);
//        if (!$update_sql_res){
//            DB::rollBack();
//        }

//        $update_sql_1= "  UPDATE zplay_basic_tg_plat_report_total_usd usd,
//        c_currency_ex cur
//        SET usd.cost = usd.cost_cny / cur.currency_ex
//        WHERE
//        cur.`effective_time` = date_format( usd.date, '%Y%m' )
