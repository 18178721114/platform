...
class BaiduHandworkHandleProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'BaiduHandworkHandleProcesses {dayid?} ';
        ...
        try { 
            foreach ($info as $k => $v) {
            	...
            	foreach ($app_list as $app_k => $app_v) {
            		...
            		if($json_info['游戏名称'] == $app_v['platform_app_name']  &&  $json_info['展现类型'] == $app_v['name'] ){
            	...
            	if(($num)>0){
                    ...
                    $error_detail_arr[$k]['first_level_id'] = $json_info['游戏名称'];
                    $error_detail_arr[$k]['first_level_name'] = $json_info['游戏名称'];
            	...
            	$array[$k]['platform_app_name'] = addslashes(str_replace('\'\'','\'',$json_info['游戏名称']));
                ...
                $array[$k]['earning_flowing'] =isset($json_info['预计收入']) ? $json_info['预计收入']: 0;
