...
class TiktokPlatHandworkHandleProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'TiktokPlatHandworkHandleProcesses {dayid?} ';
    ...
    public function handle()
    {
        ...
        self::TiktokAdDataProcess($source_id,$platform_name,$date_arr,$dayid);
    }


    public static function TiktokAdDataProcess($source_id,$platform_name,$date_arr,$dayid){
        //查询pgsql 的数据
        $map =[];
