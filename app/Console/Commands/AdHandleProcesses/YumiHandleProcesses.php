...
class YumiHandleProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'YumiHandleProcesses {dayid?} ';
...
//        }
        ...
        //玉米数据库取回来的数据
        $sql ="select * from yumi_report_data where date = '{$dayid}' and earning > 0";
...
//            $json_info = json_decode($v['json_data'],true);
           ...
           if($num_adtype){
            ...
            if(($num+$num_country+$num_adtype)>0){
                ...
                $error_detail_arr[$k]['second_level_name'] = addslashes($json_info['slot_uuid']);
