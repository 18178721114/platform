...
class TapjoyHandleProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'TapjoyHandleProcesses {dayid?} ';
...
//        }
        ...
        foreach ($info as $k => $v) {
        	...
        	foreach ($country_info as $country_k => $country_v) {
        		if(strtoupper($json_info['country']) == strtoupper($country_v['name'])){
...
//            }
//            if ($num_adtype){
//                $error_log_arr['ad_type'][] = isset($json_info['ad_type']) ? $json_info['ad_type'].'('.$json_info['app_id'].')' : '' ;
//            }
