...
class PangolinHandworkHandleProcesses extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'PangolinHandworkHandleProcesses {dayid?} ';
    ...
    public function handle()
    {
        ...
        self::PangolinAdDataProcess($channel_list,$source_id,$channel_id,$platform_name,$date_arr,$dayid);
    }


    public static function PangolinAdDataProcess($channel_list,$source_id,$channel_id,$platform_name,$date_arr,$dayid){
        //查询pgsql 的数据
        $map =[];
