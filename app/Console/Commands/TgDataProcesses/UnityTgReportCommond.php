...
//        $sql = " select distinct a.platform_id,a.data_account as company_account,b.api_key,b.organization_id as Organization_ID from c_platform_account_mapping a left join c_generalize b on b.platform_id = a.platform_id and a.account = b.data_account where a.platform_id = 'ptg36' ";
