    ...
    public function handle()
    {
        ...
        WHERE
         date_time between '$begin_date' and '$end_date1'  ";
            ...
            // 异常报错
            $message = date("Y-m-d")."号,推送展示渠道广告分成数据程序报错,报错原因:".$e->getMessage();
            DataImportImp::saveDataErrorLog(5, 'pad-001', '推送展示渠道广告分成国家数据', 2, $message);
            $error_msg_arr[] = $message;
            CommonFunction::sendMail($error_msg_arr, '推送展示渠道广告分成数据');
            exit;
        }
